...
export default function App() {
  ...
  const runAnalysis = useCallback(async () => {
    ...
    try {
      ...
      // Long-running audits on free-tier infra can exceed 10 minutes.
      // Poll for up to 45 minutes before timing out in the UI.
      ...
      if (!finalResult) {
        throw new Error(
          `Analysis is still running (job: ${queued.job_id}). Check again shortly.`,
        );
      }
